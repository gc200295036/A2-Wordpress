...
// this function changes excerpt length
function custom_excerpt_length() {
	return 20;
}
add_filter('excerpt_length', 'custom_excerpt_length', 20);

// //nicks myFunction to create a  Custom Post Type
function myFunction() {
	$labels = array(
		'name' => ('Nick Brazda'),
		'singular_name' => ('Nick'),
		'menu_name' => ('Nick Brazda Pesonal Website')
	);
	$args = array (
		'label' => ('Nicks Website'),
		'description' => ('This is my website built with custom PHP & wordpress'),
		'labels' => $labels,
		'supports' => array(
			'title',
			'editor',
